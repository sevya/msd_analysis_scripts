...
def args():
	...
	seqlogo_parser.add_argument("--path","-lp", dest="logo_path", default="/dors/meilerlab/apps/Linux2/x86_64/weblogo/3.3/weblogo",help="What is the path to weblogo software? Defaults to meilerlab enviroment")
