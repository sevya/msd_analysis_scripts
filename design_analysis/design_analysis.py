...
if arg.logo:
	 analyzer_t.output_sequence_logos(
		arg.targets, arg.n_pdb, format=arg.s_format, units=arg.s_units, stacks_per_line=arg.s_stacks, stack_width=arg.s_stack_width, title=arg.s_title, x_axis_label=arg.s_x_axis,
